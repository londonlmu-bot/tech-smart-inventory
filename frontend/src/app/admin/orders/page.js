...
// Importing Framer Motion for high-fidelity UI transitions and list animations
  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="bg-gray-950/50 backdrop-blur-xl rounded-[2.5rem] border border-white/5 overflow-hidden shadow-2xl overflow-x-auto"
      >
            ...
            {loading ? (
              ...
              orders.map((order, i) => (
                <motion.tr 
                  ...
                  animate="visible"
                  key={order.id} 
                  className="hover:bg-white/[0.02] transition-all group relative"
                >
                  ...
                  <td className="p-8">
                    <div className="flex flex-col items-center space-y-4">
                      ...
                      <motion.span 
                        layout
                        className={`px-5 py-2 rounded-full text-[9px] font-black uppercase border shadow-2xl tracking-widest ${getStatusStyle(order.status)}`}
                      >
      ...
      <footer className="pt-10 text-center opacity-30 select-none">
        <p className="text-[8px] text-gray-500 font-black uppercase tracking-[1em]">TECH Personnel Registry v2.6 // Terminal_01</p>
      </footer>
    </motion.div>
  );
}