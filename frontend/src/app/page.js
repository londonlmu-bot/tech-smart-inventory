  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-red-600 overflow-x-hidden">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-red-600/10 blur-[150px] animate-pulse"></div>
        ...
        <div className="relative text-center space-y-6 px-6 -mt-16">
            <div className="overflow-hidden">
                <p className="text-red-600 font-black uppercase tracking-[0.8em] text-[11px] animate-in slide-in-from-bottom-full duration-700">
                  Engineering the Future
                </p>
            </div>
            <h2 className="text-7xl md:text-[10rem] font-black uppercase italic tracking-tighter leading-[0.85] select-none">
                THE NEXT <br/> 
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 via-red-500 to-white animate-gradient-x">GENESIS.</span>
            </h2>
      ...
      <div className="fixed top-12 left-1/2 -translate-x-1/2 z-[300]">
        {message && (
          <div className="bg-white text-black px-12 py-3 rounded-full font-black text-[10px] uppercase tracking-[0.5em] shadow-[0_0_50px_rgba(255,255,255,0.2)] animate-in slide-in-from-top-10 duration-500">
             SYSTEM: {message}
          </div>
        )}
      </div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {filteredProducts.map((product) => (
              <div key={product.id} className="group relative bg-black rounded-[3rem] border border-white/5 overflow-hidden transition-all duration-700 hover:border-red-600/40 hover:translate-y-[-10px]">
